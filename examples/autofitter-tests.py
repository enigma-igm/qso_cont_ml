...
path = "/net/vdesk/data2/buiten/MRP2/misc-figures/autofitter-tests/23_06_"
...
fig1.savefig(path+"autofitter-resids.pdf", bbox_inches="tight")
...
fig2.savefig(path+"qsmooth-resids.pdf", bbox_inches="tight")